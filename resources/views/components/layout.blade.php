                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <el-dropdown class="relative ml-3">
                                <button
                                    ...
                                    <img src="https://avatars.githubusercontent.com/u/135497827?s=400&u=99194d861fe942f4be3d84c8ee6c634860f33f77&v=4"
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">gitofjames</div>
                            <div class="text-sm font-medium text-gray-400">gitofjames@example.com</div>
                        </div>
                        <button type="button"
